...
- 评测版本：`9.0.0`
- 摘要版本：`9.0.0`
- 生成时间：2026-08-22T20:55:15.620186
- 实验状态：完整系统（全部开启）
...
| RAG 期望通过率 | 66.67% | needs_improvement |
...
| 类别 | 样本数 | 通过 | 失败 | 通过率 |
| --- | ---: | ---: | ---: | ---: |
| abuse_signal | 1 | 1 | 0 | 100.00% |
| anxiety | 1 | 1 | 0 | 100.00% |
| depressive_tendency | 1 | 0 | 1 | 0.00% |
...
- crisis_safety_assertions_100pct: 通过
